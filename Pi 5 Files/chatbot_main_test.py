...
words = pickle.load(open('model_intents\words.pkl', 'rb'))      # list of words used in training in model
classes = pickle.load(open('model_intents\classes.pkl', 'rb'))  # classes used to classify questions (intents)
...
# test for accuracy read in questions from text file 
# and output answers to a file 
out_file = open("intents_answers.txt", "a")

with open('intents_question.txt', 'r') as file:
    # Read each line in the file
    for line in file:
        ints = predict_intent(line) 
